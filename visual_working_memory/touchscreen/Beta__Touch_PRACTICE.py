...
filename = "obj/practice/8/objdata" + "_" + str(subject_number) + ".txt"
data_file = "data/practice/8/data" + "_" + str(subject_number) + ".txt"
...
if DEBUG_CODE == 0 or DEBUG_CODE == 2:
    ...
    block_data = genBlock(NUM_PRACTICE_TRIALS_PER_CONDITION,8,trials_types,1)
