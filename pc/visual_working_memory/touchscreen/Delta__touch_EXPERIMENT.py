...
filename = "obj/exp/12/objdata" + "_" + str(subject_number) + ".txt"
data_file = "data/exp/12/data" + "_" + str(subject_number) + ".txt"
...
if DEBUG_CODE == 0 or DEBUG_CODE == 2:
    ...
    block_data = genBlock(TRIALS_PER_MINIBLOCK,12,trials_types,1)
